...
Room* RoomManager::MakeRoom(uint8_t roomNum_, uint8_t timer_, unsigned int mobHp_, uint16_t userSkt1_, uint16_t userSkt2_, InGameUser* user1_, InGameUser* user2_) {
	Room* room = new Room;
	room->set(matchingManager, roomNum_, timer_, mobHp_, userSkt1_, userSkt2_, user1_,user2_);
